...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/stylesheets/chartIndex.css">
<link rel="stylesheet" type="text/css"
				...
				<table class="table table-bordered table-hover"
					...
					<thead>
						...
						<tr>
							...
							<th>所涉市州及单位<br>&nbsp;</th>
							<th>被举报次数<br><a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?
							&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}&
							isreverse=true&comparefield=number">
									升序</a> <a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}
							&isreverse=false&comparefield=number">
									降序</a></th>
							<th>回复量<br><a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?
							&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}&
							isreverse=true&comparefield=replyednumber">
									升序</a> <a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}
							&isreverse=false&comparefield=replynumbere">
									降序</a></th>
							<th>未回复量<br><a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?
							&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}&
							isreverse=true&comparefield=noreplynumber">
									升序</a> <a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}
							&isreverse=false&comparefield=noreplynumber">
									降序</a></th>
							<th>逾期回复量<br><a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?
							&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}&
							isreverse=true&comparefield=overduenumber">
									升序</a> <a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}
							&isreverse=false&comparefield=overduenumber">
									降序</a></th>
							<th>查实量<br><a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?
							&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}&
							isreverse=true&comparefield=checknumber">
									升序</a> <a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}
							&isreverse=false&comparefield=checknumber">
									降序</a></th>
							<th>查实率<br><a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?
							&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}&
							isreverse=true&comparefield=checkpercent">
									升序</a> <a
								href="${pageContext.request.contextPath}/Servlet/ChartAction?&method=query&type=${param.type}&startdate=${param.startdate}&enddate=${param.enddate}
							&isreverse=false&comparefield=checkpercent">
									降序</a></th>
					...
					<% int id=0; %>
						<c:forEach items="${datas }" var="data">
							...
							&enddate=<fmt:formatDate value="${data.enddate}" pattern="yyyy-MM-dd"/>">${data.name}</a>
								</td>
								<td>${data.number }</td>
...
<script src="${pageContext.request.contextPath}/js/pikaday.min.js"
	...
	<script src="${pageContext.request.contextPath}/js/chartIndex.js"
	type="text/javascript"></script>
